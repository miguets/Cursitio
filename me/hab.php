        ...
        <section>
            <article>
                <div class="top_signature">
                    <img src="../sources/habilidades-profesionales.webp" alt="imagen de Habilidades">
                    <h3>Habilidades de Aprendizaje y Desarrollo Personal:</h3>
                    <div class="user_type">
                        <p>Progreso: <br><span>
                        <?php
                        if (isset($_SESSION["user"])){
                ...
                <div class="cmap">
                    <div class="signature">
                        <a href="./course/video.php"><p>Técnicas de Estudio Efectivas</p></a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                    ...
                    <div class="signature">
                        <a href="./course/video.php"><p>Creatividad y Resolución de Problemas</p></a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                    ...
                    <div class="signature">
                        <a href="./course/video.php"><p>Desarrollo de Habilidades Sociales</p></a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                    ...
                    <div class="signature">
                        <a href="./examenes/habi.php"><p>Examen</p></a>
                        <p>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
