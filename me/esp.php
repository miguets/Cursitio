        ...
        <section>
            <article>
                <div class="top_signature">
                    <img src="../sources/esphome.jpg" alt="imagen de español">
                    <h3>Español Avanzado:</h3>
                    <div class="user_type">
                        <p>Progreso: <br><span>
                        <?php
                        if (isset($_SESSION["user"])){
                ...
                <div class="cmap">
                    <div class="signature">
                        <a href="./course/video.php"><p>Lectura y Comprensión de Textos</p></a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                    ...
                    <div class="signature"><a href="./course/video.php"><p>Escritura Creativa y Gramática</p></a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                            ...
                            ?>
                        </span>% Completado</p></div>
                    <div class="signature"><a href="./course/video.php"><p>Oratoria y Expresión Oral</p>  </a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                    ...
                    <div class="signature">
                        <a href="./examenes/espa.php"><p>Examen</p></a>
                        <p>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
