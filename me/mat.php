        ...
        <section>
            <article>
                <div class="top_signature">
                    <img src="../sources/mathome.jpg" alt="imagen de español">
                    <h3>Matemáticas Fundamentales:</h3>
                    <div class="user_type">
                        <p>Progreso: <br><span>
                        <?php
                        if (isset($_SESSION["user"])){
                ...
                <div class="cmap">
                    <div class="signature">
                        <a href="./course/video.php"><p>Matemáticas Básicas para Niños de Primaria</p></a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                    ...
                    <div class="signature">
                        <a href="./course/video.php"><p>Geometría Divertida para Niños</p></a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                    ...
                    <div class="signature">
                        <a href="./course/video.php"><p>Problemas de Matemáticas Creativas</p></a>
                        <p><span>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
                    ...
                    <div class="signature">
                        <a href="./examenes/mate.php"><p>Examen</p></a>
                        <p>
                        <?php
                            if (isset($_SESSION["user"])){
                                if($usertipo == 2){
